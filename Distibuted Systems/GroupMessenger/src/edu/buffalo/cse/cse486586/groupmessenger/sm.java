...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            /*
             * Here i am accepting the socket connection and reading the data off the buffer in the socket
             * and passing the data to the publishProgress() method to print the message on the UI
             */
            BufferedReader recvbuffer = null;		
            String tempmsg = null;
            while(true)
            {
	            try
	            {
	            	...
	            	recvbuffer = new BufferedReader(new InputStreamReader(temmpsock.getInputStream()));
	            	tempmsg = recvbuffer.readLine();
	            	publishProgress(tempmsg);
	            	recvbuffer.close();
	            	temmpsock.close();
	            }
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /*
                 * Here i am reading the input via the buffer and writing it to the buffer in the socket
                 * Then i am sending the data via the socket to the server
                 */
                
                PrintWriter msgbuffer = null;
                msgbuffer = new PrintWriter(socket.getOutputStream(), true);
                msgbuffer.write(msgToSend);
                msgbuffer.flush();
                msgbuffer.close();
                socket.close();
