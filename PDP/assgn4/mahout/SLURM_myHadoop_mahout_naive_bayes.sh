...
$MAHOUT_HOME/bin/mahout seq2sparse -i /data/tweets-seq -o /data/tweets-vectors
...
##### Run file for K-Means,covert to reable format, copy from dfs to local and close ####
