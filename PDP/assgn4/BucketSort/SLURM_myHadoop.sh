...
#SBATCH --output=Result_word_count_p5.out
#SBATCH --error=Result_word_count_p5.out
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR jar hadoop-0.20.1-examples.jar WordCount README.txt output_wordcount
